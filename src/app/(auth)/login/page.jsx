        ...
        <div className='bg-stone-100 h-screen flex justify-center items-center'>
            <div className="card shadow bg-white p-10">
                ...
                <form action="" className='mt-5 space-y-5'>
                    ...
                    <input type="email" className='input bg-stone-100 mt-3 w-full' placeholder='Enter Your Email' name="" id="" /><br />
                    <label className='font-bold ' >Email Address</label>
                    <input type="email" className='input bg-stone-100 mt-3 w-full' placeholder='Enter Your Email' name="" id="" />
