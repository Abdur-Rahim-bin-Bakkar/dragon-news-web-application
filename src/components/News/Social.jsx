    ...
    return (
        <div className=''>
            ...
            <div className="flex flex-col gap-2 mt-5">
                <button onClick={handleGoogleLogin} className='btn btn-outline border-sky-600 text-sky-500'><FaGoogle /> Login With Google</button>
               
               <button onClick={signInGitHub} className='btn btn-outline'><FaGithub /> Login With GitHub</button>
            </div>
